...
describe('ReferralService', () => {
  ...
  describe('validateReferralCode', () => {
    ...
    it('should throw error for invalid referral code', async () => {
      ...
      await expect(
        service.validateReferralCode('INVALID', 'user-id'),
    ...
    it('should throw error for self-referral', async () => {
      ...
      await expect(
        service.validateReferralCode('VALID123', 'user-id'),
    ...
    it('should throw error if user already referred', async () => {
      ...
      jest
        ...
        .mockResolvedValue(existingReferral);
  ...
  describe('getReferralStats', () => {
    ...
    it('should throw error for non-existent user', async () => {
      ...
      await expect(service.getReferralStats('invalid-id')).rejects.toThrow(
        BadRequestException,
      );
    });
  });
